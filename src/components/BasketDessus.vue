...
<template>
    <svg id="Calque_1" data-name="Calque 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 379.82 140.76">
        ...
        <path
            ...
            transform="translate(-13.07 -25.23)" :fill="pointe" stroke="black" stroke-width="3" stroke-miterlimit="10"
            class="pointe"></path>
        <path
            ...
            transform="translate(-13.07 -25.23)" :fill="languette" stroke="black" stroke-width="3"
            stroke-miterlimit="10" class="languette"></path>
        <rect x="266.95" y="33.24" width="9" height="76.8" :fill="lacet" stroke="black" stroke-width="3"
            stroke-miterlimit="10" class="lacet"></rect>
        <rect x="271.22" y="58.46" width="6.7" height="76.8" transform="translate(-29.42 60.15) rotate(-17.17)"
            :fill="lacet" stroke="black" stroke-width="3" stroke-miterlimit="10" class="lacet"></rect>
        <rect x="236.14" y="93.54" width="76.8" height="6.7" transform="translate(87.85 305.37) rotate(-72.83)"
            :fill="lacet" stroke="black" stroke-width="3" stroke-miterlimit="10" class="lacet"></rect>
        <rect x="249.12" y="58.46" width="6.7" height="76.8" transform="translate(-30.41 53.62) rotate(-17.17)"
            :fill="lacet" stroke="black" stroke-width="3" stroke-miterlimit="10" class="lacet"></rect>
        <rect x="214.19" y="93.51" width="76.8" height="6.7" transform="translate(72.41 284.36) rotate(-72.83)"
            :fill="lacet" stroke="black" stroke-width="3" stroke-miterlimit="10" class="lacet"></rect>
        <rect x="227.42" y="58.46" width="6.7" height="76.8" transform="translate(-31.38 47.21) rotate(-17.17)"
            :fill="lacet" stroke="black" stroke-width="3" stroke-miterlimit="10" class="lacet"></rect>
        <rect x="192.41" y="93.52" width="76.8" height="6.7" transform="translate(57.06 263.57) rotate(-72.83)"
            :fill="lacet" stroke="black" stroke-width="3" stroke-miterlimit="10" class="lacet"></rect>
        <rect x="204.52" y="58.46" width="6.7" height="76.8" transform="translate(-32.4 40.45) rotate(-17.17)"
            :fill="lacet" stroke="black" stroke-width="3" stroke-miterlimit="10" class="lacet"></rect>
        <rect x="169.51" y="93.51" width="76.8" height="6.7" transform="translate(40.92 241.68) rotate(-72.83)"
            :fill="lacet" stroke="black" stroke-width="3" stroke-miterlimit="10" class="lacet"></rect>
        <rect x="180.92" y="48.16" width="6.7" height="87.3" transform="translate(-31.96 33.26) rotate(-17.17)"
            :fill="lacet" stroke="black" stroke-width="3" stroke-miterlimit="10" class="lacet"></rect>
        ...
        <path
            ...
            transform="translate(-13.07 -25.23)" :fill="bande" stroke="black" stroke-width="3" stroke-miterlimit="10"
            class="bande"></path>
        <path
            d="M184.35,133.7s-3.89,18.53-12.34,25.59H125.73A46.37,46.37,0,0,0,146.8,140l14-4.7,9.95-1-2.4,7.78,6.4,2,3.06-9.93Z"
            transform="translate(-13.07 -25.23)" :fill="empeigne" stroke="black" stroke-width="3" stroke-miterlimit="10"
            class="empeigne"></path>
        <path d="M179.82,40.17,188.17,63l-10-2.15-3.62-11.7-6.4,2,2.36,7.62-20.93-8.15s-2.88-9.09-15.9-13.5Z"
            transform="translate(-13.07 -25.23)" :fill="empeigne" stroke="black" stroke-width="3" stroke-miterlimit="10"
            class="empeigne"></path>
        <path
            ...
            transform="translate(-13.07 -25.23)" :fill="trimestre" stroke="black" stroke-width="3"
            stroke-miterlimit="10" class="trimestre"></path>
        <path
